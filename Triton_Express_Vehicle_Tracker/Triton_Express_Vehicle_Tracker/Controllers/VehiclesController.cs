...
namespace Triton_Express_Vehicle_Tracker.Controllers
{
    ...
    public class VehiclesController : ControllerBase
    {
        ...
        public VehiclesController(TritonExpressContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PutVehicle([FromRoute] int id, [FromBody] Vehicle vehicle)
        {
            ...
            if (id != vehicle.Vehicle_Registration_Number)
            {
                return BadRequest();
            }
        ...
        public async Task<IActionResult> PostVehicle([FromBody] Vehicle vehicle)
        {
            ...
            return CreatedAtAction("GetVehicle", new { id = vehicle.Vehicle_Registration_Number }, vehicle);
        }
        ...
        {
            return _context.Vehicles.Any(e => e.Vehicle_Registration_Number == id);
        }
    }
}